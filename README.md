...
Reproducible pipeline for geometric morphometrics of bovid M2 landmarks: ImageJ export -> Generalized Procrustes Analysis  with sliding semilandmarks ->PCA -> LDA and ML classification
